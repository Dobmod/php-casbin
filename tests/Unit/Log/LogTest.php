...
class LogTest extends TestCase
{
    ...
    public function testLog()
    {
        ...
        Log::getLogger()->logModel([]);
        Log::getLogger()->logEnforce('my_matcher', ['bob'], true, []);
        Log::getLogger()->logPolicy([]);
        Log::getLogger()->logRole([]);
        Log::getLogger()->logError(new \Exception(), 'test');
    }
}
